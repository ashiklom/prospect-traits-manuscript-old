...
*Papers to read, because they're similar, or otherwise relevant to the analyses*
    ...
    * @grime_evidence_1977 -- Prominent ecological theory of trait variability
    * @sandel_multidimensional_2016 -- Good introduction text to traits (and look through refs therein)
    * Other windows still open in Chrome...
